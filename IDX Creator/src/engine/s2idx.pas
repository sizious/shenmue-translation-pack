...
function TS2IDXCreator.MakeIDX(InputAFS:String; OutputIDX:String): Boolean;
var
    ...
    try
      ...
      begin
          ...
          begin
                ...
                if Assigned(fIDXStatus) then
                  fIDXStatus('"'+ExtractFileName(InputAFS)+'" is not a valid Shenmue II AFS file. IDX creation stopped...');
                if Assigned(fIDXCreationEndEvent) then
                  fIDXCreationEndEvent();
          end;
