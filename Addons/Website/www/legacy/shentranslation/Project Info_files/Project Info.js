IMpreload('Project Info_files', 'shapeimage_2', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("id1", "Project Info_files/transparent.gif");
    fixupIEPNG("id2", "Project Info_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_0", "Project Info_files/transparent.gif");
    fixupIEPNG("shapeimage_2", "Project Info_files/transparent.gif");
    fixupIEPNG("id4", "Project Info_files/transparent.gif");
    fixupIEPNG("id5", "Project Info_files/transparent.gif");
    return true;
}
