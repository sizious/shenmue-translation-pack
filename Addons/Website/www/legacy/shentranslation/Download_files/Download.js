IMpreload('Download_files', 'shapeimage_2', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("shapeimage_2_link_0", "Download_files/transparent.gif");
    fixupIEPNG("shapeimage_2", "Download_files/transparent.gif");
    fixupIEPNG("id2", "Download_files/transparent.gif");
    return true;
}
