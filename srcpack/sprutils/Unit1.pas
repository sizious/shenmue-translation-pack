...
i, i2, current_index, null_bytes, int_temp, gbix_pvr:Integer;
begin
        ...
        begin
                ...
                if img_type = 'PVR' then
                begin
                        //Seeking to 'GBIX' section & reading size
                        fimg.Position := 4;
                        gbix_pvr := fimg.Reader.ReadLongInt;
                        int_temp := 28 + (gbix_pvr-4);
                end
                else
                begin
                        gbix_pvr := 4;
                ...
                fspr.Writer.WriteLongInt((fimg.Size-int_temp)+ 44 + (gbix_pvr-4));
                ...
                if (img_type = 'PVR') and (gbix_pvr > 4) then
                begin
                        fspr.Writer.WriteLongInt(gbix_pvr);
                        fimg.Position := 8;

                        for i2:=0 to (gbix_pvr)-1 do
                        begin
                                fspr.Writer.WriteByte(fimg.ReadByte);
                        end;
                end
                else
                begin
                ...
                if img_type = 'PVR' then
                begin
                        int_temp := ((fimg.Size-(28+(gbix_pvr-4)))+44)-36;
                end
                else
                begin
                ...
                if img_type = 'PVR' then
                begin
                        int_temp := fimg.Size - (28+(gbix_pvr-4));
                        fimg.Position := (28+(gbix_pvr-4));
                end
                else
                begin
                        int_temp := fimg.Size;
