...
i, i2, block_size, block_num, sub_total_length, int_buffer:Integer;
begin
        //Modifying Form1
        Open1.Enabled := False;
        Saveas1.Enabled := False;
        ...
        begin
                ...
                begin
                        ...
                        if (CharsModmenu1.Checked) and (CharsModmenu1.Enabled) then
                        begin
                                ...
                                begin
                                        ...
                                        begin
                                                int_buffer := process_char(TSRFEntry(srf_data[i]).Subtitle[i2]);
                                        end;

                                        //Writing in the SRF file
                                        if int_buffer <> -1 then
                                        begin
                                                fsrf.Writer.WriteByte(int_buffer);
                                        end
                                        else
                                        begin
