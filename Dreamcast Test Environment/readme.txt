...
__/ /_/ (_-</ _ `/ _ `/ -_)_____________________________________________________
  ...
  To use this, you'll need at least the Shenmue Dreamcast episode game data 
  files of the episode you want to translate. In case of you have dumped it from 
  your Dreamcast, you can also extract the needed files from your GDI dump.
  ...
  it can't directly be read by nullDC. You must use a Virtual Drive like 
  ...
  *****************************************************************************
  *           TO GIGABYTE MOTHERBOARD USERS WITH THE GES FEATURE:             * 
  *                                                                           *
  * If you are using a Gigabyte motherboard with the Gigabyte Energy Saver    * 
  * feature, you'll need to switch this off before using a Virtual Drive soft * 
  * based on the SPTD layer (like Alcohol or Daemon Tools). *IF YOU DON'T DO  * 
  * SO, THE USE OF A VIRTUAL DRIVE WILL FREEZES OR HANGS-UP YOUR COMPUTER.*   * 
  *                                                                           *
  *   1. Run the "EnergySaver" Windows application.                           *
  *   2. Click on the "DYNAMIC ENERGY SAVER" button to switch off.            *
  *   3. Close the application.                                               *
  *   4. Click on the Start Menu, and select the Execute (or Run, I have a    *
  *      French Windows and I don't know how it's called on your system)      *
  * 	 command.                                                             *
...
___/ /__/ __/ -_) _  / / __(_-<_________________________________________________
 ...
 My Website is http://sbibuilder.shorturl.com/ 
